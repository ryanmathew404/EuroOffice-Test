OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin": "Nextcloud Office app is niet geconfigureerd. Neem contact op met de admin",
    ...
    "Nextcloud Office cannot be reached. Please contact admin": "Nextcloud Office kan niet worden bereikt. Neem contact op met de admin",
    "Loading, please wait.": "Laden, wacht alstublieft.",
    "File created": "Bestand Aangemaakt",
    "Open in Nextcloud Office": "Openen in Nextcloud Office",
    "Convert with Nextcloud Office": "Converteer met Nextcloud Office",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "Nextcloud Office Location geeft het adres op van de server waarop de documentdiensten geïnstalleerd zijn. Verander de '<documenterver>' voor het serveradres in de onderstaande regel.",
    "Nextcloud Office address": "Nextcloud Office adres",
    "Advanced server settings": "Geavanceerde serverinstellingen",
    "Nextcloud Office address for internal requests from the server": "Adres van de Nextcloud Office voor interne verzoeken van de server",
    "Server address for internal requests from Nextcloud Office": "Serveradres voor interne verzoeken van de Nextcloud Office",
    ...
    "Save": "Opslaan",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required.": "Gemende Actieve Inhoud is niet toegestaan. HTTPS-adres voor Nextcloud Office is vereist.",
    ...
    "Connect to demo Nextcloud Office server": "Verbinden met de demo Nextcloud Office server",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server.": "De 30-dagen proefperiode is voorbij, u kunt niet langer verbinding maken met demo Nextcloud Office server.",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data.": "U gebruikt de openbare demo Nextcloud Office server. Sla geen vertrouwelijke gegevens op.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Gebruik Nextcloud Office om een voorbeeld van een document te genereren (dit neemt schijfruimte in beslag)",
    ...
    "Provide advanced document permissions using Nextcloud Office": "Geavanceerde documentrechten geven met Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "Nextcloud Office server is niet beschikbaar",
    ...
    "Nextcloud Office Document Server is unavailable": "Nextcloud Office Document Server is niet beschikbaar",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Dit is een e-mailbericht om te melden dat de verbinding met de Nextcloud Office Document Server verbroken is. Controleer de verbindingsinstellingen:",
    ...
    "Welcome to Nextcloud Office!": "Welkom bij Nextcloud Office!",
