OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Nextcloud Office-appen är inte aktiverad. Kontakta systemadministratören",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Nextcloud Office inte nåbar.  Kontakta systemadministratören",
    "Loading, please wait." : "Laddar... var god vänta.",
    "File created" : "Filen skapad",
    "Open in Nextcloud Office" : "Öppna i Nextcloud Office",
    "Convert with Nextcloud Office" : "Konvertera med Nextcloud Office",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Nextcloud Office plats specificerar adressen till servern där Nextcloud Office är installerad. Ändra '<dokumentserver>' till serverns adress i nedanstående rad.",
    "Nextcloud Office address" : "Adress till Nextcloud Office",
    "Advanced server settings" : "Avancerade serverinställningar",
    "Nextcloud Office address for internal requests from the server" : "Adress till Nextcloud Office för interna förfragningar från servern",
    "Server address for internal requests from Nextcloud Office" : "Serveradress för interna förfrågningar från Nextcloud Office",
    ...
    "Save" : "Spara",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Blandat aktivt innehåll är inte tillåtet. HTTPS-adress till Nextcloud Office krävs.",
    ...
    "Editor customization settings" : "Anpassningar Nextcloud Office ",
    ...
    "Connect to demo Nextcloud Office server" : "Anslut till demo Nextcloud Officeserver",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "När 30-dagars testperioden är över, kan du inte längre ansluta till demo Nextcloud Officeserver.",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Du använder en offentlig demo Nextcloud Officeserver. Lagra inte privat känslig information.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Använd Nextcloud Office för att generera en förhandsgranskning av dokument (detta använder diskutrymme)",
    ...
    "group": "grupp",
    "Advanced": "Avancerad",
    "Provide advanced document permissions using Nextcloud Office": "Tillhandahåll avancerade dokumentbehörigheter med Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "Nextcloud Office-servern är inte tillgänglig",
    ...
    "Open file": "Öppna fil",
    "Nextcloud Office Document Server is unavailable": "Nextcloud Office Document Server är inte tillgänglig",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Detta är ett e-postmeddelande för att meddela att anslutningen till Nextcloud Office Document Server har förlorats. Kontrollera anslutningsinställningarna:",
