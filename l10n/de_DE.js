OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Nextcloud Office App ist nicht konfiguriert. Bitte wenden Sie sich an Ihren Administrator",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Nextcloud Office ist zurzeit nicht erreichbar.  Bitte wenden Sie sich an Ihren Administrator",
    "Loading, please wait." : "Laden... Bitte warten.",
    "File created" : "Erstellte Datei",
    "Open in Nextcloud Office" : "In Nextcloud Office öffnen",
    "Convert with Nextcloud Office" : "Mit Nextcloud Office umwandeln",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Nextcloud Officestandort gibt die Adresse des Servers mit den installierten Dokumentdiensten an. Bitte ändern Sie '<documenterver>' für die Serveradresse in der folgenden Zeile.",
    "Nextcloud Office address" : "Die Adresse von Nextcloud Office",
    "Advanced server settings" : "Erweiterte Servereinstellungen",
    "Nextcloud Office address for internal requests from the server" : "Die Adresse von Nextcloud Office für interne Anforderungen vom Server",
    "Server address for internal requests from Nextcloud Office" : "Serveradresse für interne Anforderungen vom Nextcloud Office",
    ...
    "Save" : "Speichern",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Mixed Active Content ist nicht möglich. HTTPS-Adresse für Nextcloud Office ist erforderlich.",
    ...
    "Connect to demo Nextcloud Office server": "Verbindung zu Demo Nextcloud Office Server herstellen",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server.": "Der 30-tägige Testzeitraum ist abgelaufen. Sie können keine Verbindung mehr zu Demo Nextcloud Office Server herstellen.",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data.": "Sie verwenden den öffentlichen Demo Nextcloud Office Server. Bitte benutzen Sie ihn nicht zum Speichern von Ihren privaten sensiblen Daten.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Nextcloud Office verwenden, um eine Dokumentvorschau zu erstellen (Speicherplatz erforderlich)",
    ...
    "group": "gruppe",
    "Advanced": "Erweitert",
    "Provide advanced document permissions using Nextcloud Office": "Erweiterte Zugriffsrechte in Nextcloud Office vergeben",
    ...
    "Nextcloud Office server is not available": "Nextcloud Office-Server ist nicht verfügbar",
    ...
    "Nextcloud Office Document Server is unavailable": "Nextcloud Office Document Server ist nicht verfügbar",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Dies ist eine E-Mail-Nachricht, die Sie darüber informiert, dass die Verbindung mit dem Nextcloud Office Document Server unterbrochen wurde. Bitte überprüfen Sie die Verbindungseinstellungen:",
    ...
    "Welcome to Nextcloud Office!": "Willkommen bei Nextcloud Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Nextcloud Office.": "Mit Nextcloud Office können Sie Textdokumente, Tabellenkalkulationen, Präsentationen und PDFs innerhalb von Nextcloud gemeinsam bearbeiten.",
