OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Nextcloud Office App ist nicht konfiguriert. Bitte wende Dich an Deinen Administrator",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Nextcloud Office ist zurzeit nicht erreichbar.  Bitte wende Dich an Deinen Administrator",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "Der 30-tägige Testzeitraum ist abgelaufen. Du kannst keine Verbindung mehr zu Demo Nextcloud Office Server herstellen.",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Du verwendest den öffentlichen Demo Nextcloud Office Server. Bitte benutze ihn nicht zum Speichern von Deinen privaten sensiblen Daten.",
