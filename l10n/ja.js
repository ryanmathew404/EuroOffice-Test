OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Nextcloud Officeアプリが設定されていません。管理者に相談してください",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Nextcloud Officeに接続できません。管理者に相談してください",
    "Loading, please wait." : "読み込み中です...。しばらくお待ちください。",
    "File created": "ファイルが作成されました",
    "Open in Nextcloud Office" : "Nextcloud Officeで開く",
    "Convert with Nextcloud Office" : "Nextcloud Officeで変換",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "Docsアドレスにはドキュメントサービスがインストールされているサーバーのアドレスを指定します。以下の行の'<documentserver>'をサーバーアドレスに変更してください。",
    "Nextcloud Office address" : "Nextcloud Office アドレス",
    "Advanced server settings": "サーバー詳細設定",
    "Nextcloud Office address for internal requests from the server": "サーバーから内部リクエストに利用されるNextcloud Office アドレス",
    "Server address for internal requests from Nextcloud Office": "Nextcloud Officeから内部リクエストに利用されるサーバーアドレス",
    ...
    "Save" : "保存",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "アクティブコンテンツの混在は許可されていません。Nextcloud OfficeにはHTTPSアドレスが必要です",
    ...
    "Connect to demo Nextcloud Office server" : "Nextcloud Officeのデモサーバーに接続する",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "30日間のテスト期間が終了したら、Nextcloud Office デモサーバーには繋がらなくなります。",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "パブリック Nextcloud Office サーバーを使っているので、プライベートな機密データを利用しないようにしてください。",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Nextcloud Officeを使用してドキュメントのサムネールを生成する(ディスク容量を消費します)",
    ...
    "group": "グループ",
    "Advanced": "詳細",
    "Provide advanced document permissions using Nextcloud Office": "Nextcloud Officeを利用した高度なドキュメント権限の提供",
    ...
    "Nextcloud Office server is not available": "Nextcloud Officeサーバーは只今利用できません",
    ...
    "Open file": "ファイルを開く",
    "Nextcloud Office Document Server is unavailable": "Nextcloud Officeドキュメントサーバーは只今ご利用いただけません",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "これは、Nextcloud Officeドキュメントサーバーとの接続が失われたことを通知するメッセージです。接続設定をご確認ください：",
    ...
    "Welcome to Nextcloud Office!": "Nextcloud Officeへようこそ！",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Nextcloud Office.": "Nextcloud Officeを使用して、Nextcloud内でテキストドキュメント、スプレッドシート、プレゼンテーション、PDFを編集・共同作業できます。",
    "Learn more": "詳細を見る",
    ...
    "To ensure the security of important parameters in Nextcloud Office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Nextcloud Officeリクエストの重要なパラメータのセキュリティを確保するため、設定ページでシークレットキーを設定してください。詳細については、<a href=\"{url}\" target=\"_blank\">こちらをクリック</a>してください。",
    "Info": "情報",
    "Open": "開く",
