OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Приложението Nextcloud Office не конфигурирано. Моля, свържете се с администратора",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Приложението Nextcloud Office не е достъпно. Моля, свържете се с администратора",
    "Loading, please wait." : "Зареждане. Моля, изчакайте.",
    "File created" : "Файлът е създаден",
    "Open in Nextcloud Office" : "Отвори в Nextcloud Office",
    "Convert with Nextcloud Office" : "Конвертирай с Nextcloud Office",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Адреса на Nextcloud Office определя адреса на сървъра с инсталирани услуги за документи. Моля, променете '<documentserver>' адреса на сървъра в долния ред.",
    "Nextcloud Office address" : "Адрес на Nextcloud Office",
    "Advanced server settings" : "Допълнителни настройки на сървъра",
    "Nextcloud Office address for internal requests from the server" : "Адрес на Nextcloud Office за вътрешни заявки към сървъра",
    "Server address for internal requests from Nextcloud Office" : "Адрес на сървъра за вътрешни заявки на Nextcloud Office",
    ...
    "Save" : "Запази",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Смесеното активно съдържание е недопустимо. За Nextcloud Office е необходимо използването на HTTPS-адрес.",
    ...
    "Connect to demo Nextcloud Office server" : "Свързване с демо Nextcloud Office сървър",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "30-дневният тестов период приключи, вече не можете да се свържете с демо Nextcloud Office сървър.",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Използвате обществения демо Nextcloud Office сървър. Моля, не съхранявайте чувствителни частни данни на него.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Използвайте Nextcloud Office, за да генерирате преглед на документа (ще заеме дисково пространство)",
    ...
    "Provide advanced document permissions using Nextcloud Office": "Предоставете нови разрешения за документи с помощта на Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "Nextcloud Office сървърът не е достъпен",
    ...
    "Nextcloud Office Document Server is unavailable": "Nextcloud Office Сървъра за документи не е достъпен",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Това е имейл съобщение, известяващо, че връзката с Nextcloud Office сървъра за документи беше прекъсната. Моля, проверете настройките на свързване:",
