OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Приложение Nextcloud Office не сконфигурировано. Пожалуйста, свяжитесь с администратором.",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Приложение Nextcloud Office недоступно. Пожалуйста, свяжитесь с администратором.",
    "Loading, please wait." : "Загрузка. Пожалуйста, подождите.",
    "File created" : "Файл создан",
    "Open in Nextcloud Office" : "Открыть в Nextcloud Office",
    "Convert with Nextcloud Office" : "Конвертировать в Nextcloud Office",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Расположение Nextcloud Office определяет адрес сервера с установлеными службами документов. Пожалуйста, замените '<documentserver>' в поле ниже на адрес сервера.",
    "Nextcloud Office address" : "Адрес Nextcloud Office",
    "Advanced server settings" : "Дополнительные настройки сервера",
    "Nextcloud Office address for internal requests from the server" : "Адрес Nextcloud Office для внутренних запросов сервера",
    "Server address for internal requests from Nextcloud Office" : "Адрес сервера для внутренних запросов Nextcloud Office",
    ...
    "Save" : "Сохранить",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Смешанное активное содержимое запрещено. Для Nextcloud Office необходимо использовать HTTPS-адрес.",
    ...
    "Connect to demo Nextcloud Office server" : "Подключиться к демонстрационному серверу Nextcloud Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "30-дневный тестовый период закончен, вы больше не можете подключаться к демонстрационному серверу Nextcloud Office",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Вы используете публичный демонстрационный сервер Nextcloud Office. Пожалуйста, не храните конфиденциальные данные.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Использовать Nextcloud Office для создания превью документа (займет место на диске)",
    ...
    "Provide advanced document permissions using Nextcloud Office": "Предоставление расширенных прав доступа к документам с помощью Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "Сервер Nextcloud Office недоступен",
    ...
    "Nextcloud Office Document Server is unavailable" : "Сервер документов Nextcloud Office недоступен",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:" : "Это почтовое сообщение, уведомляющее о том, что соединение с сервером документов Nextcloud Office потеряно. Пожалуйста, проверьте настройки подключения:",
    ...
    "Welcome to Nextcloud Office!": "Добро пожаловать в Nextcloud Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Nextcloud Office.": "Редактируйте текстовые документы, электронные таблицы, презентации и PDF-файлы, а также работайте над ними вместе с другими пользователями в Nextcloud, используя Nextcloud Office.",
