OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Nextcloud Office aplikazioa ez dago konfiguratuta. Mesedez, jarri administradorearekin harremanetan",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Ezin da Nextcloud Office-era iritsi. Mesedez, jarri administradorearekin harremanetan",
    "Loading, please wait." : "Kargatzen, itxaron mesedez.",
    "File created" : "Fitxategia sortuta",
    "Open in Nextcloud Office" : "Ireki Nextcloud Office-ekin",
    "Convert with Nextcloud Office" : "Bihurtu Nextcloud Office-ekin",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Nextcloud Office-en kokapenak dokumentu zerbitzuak instalatuta daude zerbitzariaren helbidea zehazten du. Mesedez, aldatu '<documentserver>' zerbitzariaren helbideagatik beheko lerroan.",
    "Nextcloud Office address" : "Nextcloud Office-en helbidea",
    "Advanced server settings" : "Zerbitzariaren ezarpen aurreratuak",
    "Nextcloud Office address for internal requests from the server" : "Nextcloud Office-en helbidea zerbitzariaren barneko eskaeretarako",
    "Server address for internal requests from Nextcloud Office" : "Zerbitzariaren helbidea Nextcloud Office-en barneko eskaeretarako",
    ...
    "Save" : "Gorde",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Eduki Nahasi Aktiboa ez da onartzen. Nextcloud Office-erako HTTPS helbidea behar da.",
    ...
    "Connect to demo Nextcloud Office server" : "Konektatu Nextcloud Office demo zerbitzarira",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "30 eguneko probaldia amaitu da, ezin zara Nextcloud Office demo zerbitzarira gehiago konektatu",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Nextcloud Office demo zerbitzari publikoa erabiltzen ari zara. Mesedez, ez gorde zure datu konfidentzialak hemen.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Erabili Nextcloud Office dokumentuaren aurrebista sortzeko (diskoan lekua hartuko du)",
    ...
    "group": "taldea",
    "Advanced": "Aurreratua",
    "Provide advanced document permissions using Nextcloud Office": "Eman baimen aurreratuak dokumentuei Nextcloud Office erabiliz",
    ...
    "Nextcloud Office server is not available": "Nextcloud Office zerbitzaria ez dago eskuragarri",
    ...
    "Nextcloud Office Document Server is unavailable": "Nextcloud Office dokumentu-zerbitzaria ez dago eskuragarri",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Mezu elektroniko honen bidez jakinarazten dizugu Nextcloud Office dokumentu-zerbitzariarekiko konexioa galdu dela. Mesedez, berrikusi konexio ezarpenak:",
