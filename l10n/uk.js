OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Застосунок Nextcloud Office не налаштовано. Будь ласка, сконтактуйте з адміністратором",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Неможливо встановити з'єднання з Nextcloud Office. Будь ласка, сконтактуйте з адміністратором.",
    "Loading, please wait." : "Триває завантаження. Будь ласка, зачекайте.",
    "File created" : "Файл створено",
    "Open in Nextcloud Office" : "Відкрити у Nextcloud Office",
    "Convert with Nextcloud Office" : "Конвертувати у Nextcloud Office",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Розташування Nextcloud Office визначає адресу сервера зі встановленими службами документів. Будь ласка, замініть '<documentserver>' на дійсну адресу сервера.",
    "Nextcloud Office address" : "Адреса Nextcloud Office",
    "Advanced server settings" : "Додаткові налаштування сервера",
    "Nextcloud Office address for internal requests from the server" : "Адреса Nextcloud Office для внутрішніх запитів сервера",
    "Server address for internal requests from Nextcloud Office" : "Адреса сервера для внутрішніх запитів Nextcloud Office",
    ...
    "Save" : "Зберегти",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Змішаний активний вміст заборонено. Для користування Nextcloud Office потрібно використовувати безпечне з'єднання HTTPS.",
    ...
    "Connect to demo Nextcloud Office server" : "З'єднатися з демонстраційним сервером Nextcloud Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "Тестовий 30-денний період вичерпано. Ви більше не маєте змоги з'єднуватися з демонстраційним сервером Nextcloud Office",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Ви використовуєте ПУБЛІЧНИЙ демонстраційний сервер Nextcloud Office. Будь ласка, не зберігайте ваші приватні дані.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Nextcloud Office створюватиме зображення попереднього перегляду документу (потрібне місце на диску)",
    ...
    "group": "група",
    "Advanced": "Додатково",
    "Provide advanced document permissions using Nextcloud Office": "Увімкнути розширені права доступу до документів у Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "Сервер Nextcloud Office не доступний",
    ...
    "Nextcloud Office Document Server is unavailable": "Сервер документів Nextcloud Office недоступний",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Цим листом повідомляємо вам, що з'єднання з сервером документів Nextcloud Office втрачено. Перевірте параметри з'єднання:",
