OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Aplicação Nextcloud Office não está configurada. Favor contatar o administrador",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Não foi possível conectar ao Nextcloud Office. Favor contatar o administrador.",
    "Loading, please wait." : "Carregando, por favor aguarde.",
    "File created" : "Arquivo criado",
    "Open in Nextcloud Office" : "Abrir no Nextcloud Office",
    "Convert with Nextcloud Office" : "Converta com Nextcloud Office",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "O Endereço do Nextcloud Office especifica o servidor onde o serviço de documentos está instalado.\nPor favor mude '<documentserver>' para o endereço do servidor na linha abaixo.",
    "Nextcloud Office address" : "Endereço do Nextcloud Office",
    "Advanced server settings" : "Configurações avançadas do servidor",
    "Nextcloud Office address for internal requests from the server" : "Endereço do Nextcloud Office para pedidos internos do servidor",
    "Server address for internal requests from Nextcloud Office" : "Endereço do servidor para pedidos internos do Nextcloud Office",
    ...
    "Save" : "Salvar",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Conteúdo Misto não é permitido. É necessário um endereço HTTPS para o Nextcloud Office.",
    ...
    "Connect to demo Nextcloud Office server" : "Conectar ao Servidor de demonstração do Nextcloud Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "O período de teste de 30 dias acabou, você não pode mais se conectar ao Servidor de demonstração do Nextcloud Office",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Você está usando o Servidor de demonstração pública. Não armazene dados confidenciais.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Usar Nextcloud Office para gerar uma visualização do documento (ocupará espaço em disco)",
    ...
    "group": "grupo",
    "Advanced": "Avançado",
    "Provide advanced document permissions using Nextcloud Office": "Forneça permissões avançadas de documentos usando o Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "O servidor Nextcloud Office não está disponível",
    ...
    "Nextcloud Office Document Server is unavailable": "O servidor de documentos Nextcloud Office não está disponível",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Esta é uma mensagem de e-mail para notificar que a conexão com o servidor de documentos Nextcloud Office foi perdida. Verifique as configurações de conexão:",
    ...
    "Welcome to Nextcloud Office!": "Bem-vindo ao Nextcloud Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Nextcloud Office.": "Edite e colabore em documentos de texto, planilhas, apresentações e PDFs no Nextcloud usando o Nextcloud Office.",
    ...
    "To ensure the security of important parameters in Nextcloud Office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Para garantir a segurança de parâmetros importantes nas solicitações do Nextcloud Office, defina uma Chave Secreta na página Configurações. Para saber mais, <a href=\"{url}\" target=\"_blank\">clique aqui</a>.",
    "Info": "Informações",
    "Open": "Abrir",
