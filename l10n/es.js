OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "Aplicación Nextcloud Office no está configurada. Por favor, contacte con admin",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "No se puede acceder al Nextcloud Office. Por favor, contacte con admin",
    "Loading, please wait." : "Cargando, espere, por favor.",
    "File created" : "Archivo creado",
    "Open in Nextcloud Office" : "Abrir en Nextcloud Office",
    "Convert with Nextcloud Office" : "Convertir con Nextcloud Office",
    ...
    "Save" : "Guardar",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Contenido Mixto Activo no está permitido. Se requiere la dirección HTTPS para Nextcloud Office.",
    ...
    "Connect to demo Nextcloud Office server" : "Conectarse al servidor de Nextcloud Office de demostración",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "El período de prueba de 30 días ha terminado, ya no puedes conectarte al servidor de Nextcloud Office de demostración",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Estás usando el servidor de Nextcloud Office de demostración. Por favor, no almacenes tus datos confidenciales aquí.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Usar Nextcloud Office para generar una vista previa del documento (ocupará espacio en el disco)",
    ...
    "group": "grupo",
    "Advanced": "Avanzado",
    "Provide advanced document permissions using Nextcloud Office": "Proporcione permisos avanzados para los documentos utilizando Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "El servidor de Nextcloud Office no está disponible",
    ...
    "Nextcloud Office Document Server is unavailable": "El Servidor de documentos Nextcloud Office no está disponible",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Este es un mensaje de correo electrónico para notificarle que la conexión con el Servidor de documentos Nextcloud Office se ha perdido. Por favor, compruebe los ajustes de conexión:",
    ...
    "Welcome to Nextcloud Office!": "¡Bienvenido(a) a Nextcloud Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Nextcloud Office.": "Edite y colabore en documentos de texto, hojas de cálculo, presentaciones y archivos PDF dentro de Nextcloud usando Nextcloud Office.",
    ...
    "To ensure the security of important parameters in Nextcloud Office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Para garantizar la seguridad de los parámetros importantes en las solicitudes de Nextcloud Office, establezca una clave secreta en la página de configuración. Para obtener más información, <a href=\"{url}\" target=\"_blank\">haga clic aquí</a>.",
    "Info": "Información",
    "Open": "Abrir",
