OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "OAplikacja Nextcloud Office nie jest skonfigurowana. Skontaktuj się z administratorem",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Nextcloud Office jest nieosiągalny. Skontaktuj się z administratorem",
    "Loading, please wait." : "Ładowanie, proszę czekać.",
    "File created" : "Plik utworzony",
    "Open in Nextcloud Office" : "Otwórz w Nextcloud Office",
    "Convert with Nextcloud Office" : "Konwertuj",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Lokacja Nextcloud Office to adres serwera na którym Usługi Dokumentów są zainstalowe. Proszę zmienić '<documentserver>' na adres poniżej.",
    "Nextcloud Office address" : "Adres Nextcloud Office",
    "Advanced server settings" : "Zaawansowane ustawienia serwera",
    "Nextcloud Office address for internal requests from the server" : "Adres Nextcloud Office dla zapytań wewnętrznych",
    "Server address for internal requests from Nextcloud Office" : "Adres serwera dla zapytań wewnętrznych z Nextcloud Office",
    ...
    "Save" : "Zapisz",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Aktywna Zawartość Mieszana nie jest dozwolona. Adres HTTPS jest wymagany dla Nextcloud Office.",
    ...
    "Connect to demo Nextcloud Office server" : "Połącz się z serwerem demo Nextcloud Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "Upłyneło 30 dni, nie możesz się już łączyć z serwerem demo.",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Używasz publicznego serwera demo. Nie przechowuj tu prywatnych danych.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Skorzystaj z Nextcloud Office, aby wygenerować podgląd dokumentu (zajmie to miejsce na dysku)",
    ...
    "Provide advanced document permissions using Nextcloud Office": "Udziel zaawansowanych uprawnień do edycji dokumentów w Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "Serwer Nextcloud Office jest niedostępny",
    ...
    "Nextcloud Office Document Server is unavailable": "Serwer dokumentów Nextcloud Office jest niedostępny",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "To jest wiadomość e-mail informująca, że połączenie z serwerem dokumentów Nextcloud Office zostało utracone. Proszę sprawdzić ustawienia połączenia:",
    ...
    "Welcome to Nextcloud Office!": "Witaj w Nextcloud Office!",
