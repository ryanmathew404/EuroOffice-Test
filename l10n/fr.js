OC.L10N.register(
    ...
    "Files not found" : "Fichiers introuvables",
    "File not found" : "Fichier introuvable",
    "Not permitted" : "Non autorisé",
    "Download failed" : "Echec du téléchargement",
    "The required folder was not found" : "Le dossier requis n'a pas été trouvé",
    "You don't have enough permission to create" : "Vous n'avez pas la permission de créer",
    "Template not found" : "Modèle introuvable",
    "Can't create file" : "Le fichier ne peut pas être créé",
    "Format is not supported" : "Format non supporté",
    "Conversion is not required" : "Conversion non requise",
    "Failed to download converted file" : "Echec du téléchargement du fichier converti",
    "Nextcloud Office app is not configured. Please contact admin" : "L'application Nextcloud Office n'est pas configuré. Veuillez contacter votre administrateur",
    ...
    "Error occurred in the document service" : "Une erreur s'est produite dans le service de document",
    "Not supported version" : "Version non supportée",
    "Nextcloud Office cannot be reached. Please contact admin" : "Nextcloud Office est indisponible. Veuillez contacter votre administrateur",
    "Loading, please wait." : "Chargement, veuillez patienter.",
    "File created" : "Fichier créé",
    "Open in Nextcloud Office" : "Ouvrir dans Nextcloud Office",
    "Convert with Nextcloud Office" : "Convertir avec Nextcloud Office",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "L'emplacement du Nextcloud Office désigne l'adresse du serveur sur lequel est installé le service de document. Veuillez modifier le '<documentserver>' avec l'adresse du serveur de service de document dans la ligne ci-dessous",
    "Nextcloud Office address" : "Adresse du Nextcloud Office",
    "Advanced server settings" : "Paramètres avancés du serveur",
    "Nextcloud Office address for internal requests from the server" : "Adresse du Nextcloud Office pour les demandes internes du serveur",
    "Server address for internal requests from Nextcloud Office" : "Adresse du serveur pour les demandes internes du Nextcloud Office",
    ...
    "Save" : "Enregistrer",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Le contenu mixte actif n'est pas autorisé. Une adresse HTTPS pour le Nextcloud Office est requise",
    ...
    "Connect to demo Nextcloud Office server" : "Se connecter à la version démo de Nextcloud Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "La période d'essai de 30 jours est expirée, vous n'êtes plus en mesure de vous connecter à la version démo de Nextcloud Office.",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Vous utilisez la version démo de Nextcloud Office, proposée à des fins de tests. Veuillez ne pas stocker vos données confidentielles.",
    ...
    "DO NOT SHARE THIS" : "MERCI DE NE PAS LE PARTAGER",
    "Show watermark on tagged files" : "Afficher un filigrane pour les fichiers sélectionnés",
    "Show watermark for users of groups" : "Afficher un filigrane pour un groupe d'utilisateurs",
    "Supported placeholders" : "Espaces réservés supportés",
    "Show watermark for all shares" : "Afficher un filigrane à tout le monde ayant l'accès",
    "Show watermark for read only shares" : "Afficher un filigrane pour l'accès de lecture seule",
    "Link shares" : "Accès par le lien",
    "Show watermark for all link shares" : "Afficher un filigrane pour l'accès par le lien externe",
    "Show watermark for download hidden shares" : "Afficher un filigrane pour la restriction de téléchargement",
    "Show watermark for read only link shares" : "Afficher un filigrane pour l'accès de lecture seule par le lien externe",
    "Show watermark on link shares with specific system tags" : "Afficher un filigrane pour l'accès par le lien externe avec les marques spécifiques du système",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Utilisez Nextcloud Office pour générer l'aperçu du document (occupe de l'espace disque)",
    ...
    "Template already exists": "Le modèle existe déjà",
    "Template must be in OOXML format": "Le modèle doit être au format OOXML",
    ...
    "group": "groupe",
    "Advanced": "Avancé",
    "Provide advanced document permissions using Nextcloud Office": "Fournir des autorisations avancées pour les documents en utilisant Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "Le serveur Nextcloud Office n'est pas disponible",
    ...
    "Select file to combine": "Sélectionner le fichier à combiner",
    ...
    "Nextcloud Office Document Server is unavailable": "Nextcloud Office Document Server n'est pas disponible",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Ceci est un message pour vous informer que la connexion avec Nextcloud Office Document Server a été interrompue. Veuillez vérifier les paramètres de connexion :",
    "Go to Settings": "Aller dans Paramètres",
    "Select file to insert text": "Sélectionner le fichier pour insérer le texte",
    "Select file": "Sélectionner un fichier",
    "Enable sharing (might increase editors loading time)": "Activer le panneau de partage (le temps de chargement des éditeurs peut être augmenté)",
    ...
    "Are you sure you want to clear metadata?": "Voulez-vous vraiment effacer les métadonnées ?",
    "Confirm metadata removal": "Confirmer la suppression des métadonnées",
    "Welcome to Nextcloud Office!": "Bienvenue dans Nextcloud Office !",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Nextcloud Office.": "Modifiez et collaborez sur des documents texte, des feuilles de calcul, des présentations et des fichiers PDF dans Nextcloud à l'aide de Nextcloud Office.",
    "Learn more": "En savoir plus",
    "Suggest a feature": "Suggérer une fonctionnalité",
    "Server settings have been successfully updated": "Les paramètres du serveur ont été mis à jour avec succès",
    "Common settings have been successfully updated": "Les paramètres généraux ont été mis à jour avec succès",
    "Security settings have been successfully updated": "Les paramètres de sécurité ont été mis à jour avec succès",
    "To ensure the security of important parameters in Nextcloud Office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Pour garantir la sécurité des paramètres importants dans les requêtes Nextcloud Office, veuillez définir une clé secrète sur la page Paramètres. Pour en savoir plus, <a href=\"{url}\" target=\"_blank\">cliquez ici</a>.",
    "Info": "Information",
    "Open": "Ouvrir",
