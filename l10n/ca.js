OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin": "Aplicació Nextcloud Office no està configurada. Si us plau, contacti amb l'administrador",
    ...
    "Nextcloud Office cannot be reached. Please contact admin": "No es pot accedir a l'Nextcloud Office. Si us plau, contacti amb l'administrador",
    "Loading, please wait.": "Carregant, esperi, si us plau.",
    "File created": "Arxiu creat",
    "Open in Nextcloud Office": "Obrir en Nextcloud Office",
    "Convert with Nextcloud Office": "Convertir amb Nextcloud Office",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "Ubicació de l'Nextcloud Office especifica la direcció del servidor amb els serveis de documents instal·lats. Si us plau, canviï '<documentserver>' per a la direcció de servidor en la línia inferior.",
    "Nextcloud Office address": "Direcció d'Nextcloud Office",
    "Advanced server settings": "Ajustos de servidor avançats",
    "Nextcloud Office address for internal requests from the server": "Direcció d'Nextcloud Office per a sol·licituds internes del servidor",
    "Server address for internal requests from Nextcloud Office": "Direcció de servidor per a sol·licituds internes de l'Nextcloud Office",
    ...
    "Save": "Guardar",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required.": "Contingut Mixt Actiu no està permès. Es requereix la direcció HTTPS per a Nextcloud Office.",
    ...
    "Connect to demo Nextcloud Office server": "Connectar-se al servidor de Nextcloud Office de demostració",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server.": "El període de prova de 30 dies ha acabat, ja no pots connectar-te al servidor d'Nextcloud Office de demostració",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data.": "Estàs fent servir el servidor d'Nextcloud Office de demostració. Si us plau, no emmagatzemis les teves dades confidencials aquí.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Usar Nextcloud Office per a generar una vista prèvia del document (ocuparà espai en el disc)",
    ...
    "group": "agrupa",
    "Advanced": "Avançat",
    "Provide advanced document permissions using Nextcloud Office": "Proporcioneu permisos avançats de documents mitjançant Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "El servidor Nextcloud Office no està disponible",
    ...
    "Nextcloud Office Document Server is unavailable": "El servidor de documents Nextcloud Office no està disponible",
    "This is a mail message to notify that the connection with the Nextcloud Office Document Server has been lost. Please check the connection settings:": "Aquest és un missatge de correu electrònic per notificar que s'ha perdut la connexió amb el servidor de documents Nextcloud Office. Comproveu la configuració de connexió:",
