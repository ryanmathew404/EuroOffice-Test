OC.L10N.register(
    ...
    "Nextcloud Office app is not configured. Please contact admin" : "L'applicazione Nextcloud Office non è configurata. Si prega di contattare l'amministratore",
    ...
    "Nextcloud Office cannot be reached. Please contact admin" : "Non è possibile raggiungere Nextcloud Office. Si prega di contattare l'amministratore",
    "Loading, please wait." : "Caricamento in corso, attendere prego",
    "File created" : "File creato",
    "Open in Nextcloud Office" : "Apri in Nextcloud Office",
    "Convert with Nextcloud Office" : "Converti con Nextcloud Office",
    ...
    "Nextcloud Office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Nextcloud Office Location specifica l'indirizzo del server con i servizi documenti installati. Modifica il '<documentserver>' con l'indirizzo del server nella riga sottostante.",
    "Nextcloud Office address" : "Indirizzo di Nextcloud Office",
    "Advanced server settings" : "Impostazioni avanzate del server",
    "Nextcloud Office address for internal requests from the server" : "Indirizzo di Nextcloud Office per le richieste interne del server",
    "Server address for internal requests from Nextcloud Office" : "Indirizzo del server per le richieste interne da Nextcloud Office",
    ...
    "Save" : "Salva",
    "Mixed Active Content is not allowed. HTTPS address for Nextcloud Office is required." : "Il contenuto attivo misto non è consentito. È richiesto l'indirizzo HTTPS per Nextcloud Office.",
    ...
    "Connect to demo Nextcloud Office server" : "Collegati alla versione demo di Nextcloud Office",
    ...
    "The 30-day test period is over, you can no longer connect to demo Nextcloud Office server." : "Il periodo di prova di 30 giorni è terminato; non è più possibile connettersi alla versione demo di Nextcloud Office.",
    "You are using public demo Nextcloud Office server. Please do not store private sensitive data." : "Stai utilizzando la versione demo pubblica di Nextcloud Office. Non memorizzare dati sensibili privati.",
    ...
    "Use Nextcloud Office to generate a document preview (it will take up disk space)": "Usare Nextcloud Office per generare anteprima documenti (occuperà spazio su disco)",
    ...
    "group": "gruppo",
    "Advanced": "Avanzate",
    "Provide advanced document permissions using Nextcloud Office": "Fornisci autorizzazioni avanzate per i documenti utilizzando Nextcloud Office",
    ...
    "Nextcloud Office server is not available": "Il server di Nextcloud Office non è disponibile",
    ...
    "Welcome to Nextcloud Office!": "Benvenuto in Nextcloud Office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Nextcloud Office.": "Modifica e collabora su documenti di testo, fogli di calcolo, presentazioni e PDF all'interno di Nextcloud usando Nextcloud Office.",
    ...
    "To ensure the security of important parameters in Nextcloud Office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Per garantire la sicurezza dei parametri importanti nelle richieste di Nextcloud Office, imposta una Chiave Segreta nella pagina delle Impostazioni. Per saperne di più, <a href=\"{url}\" target=\"_blank\">clicca qui</a>.",
    "Info": "Info",
    "Open": "Apri",
